...
- **Maturity:** early — `memory` (10), `copy-move` (8), `cache-layout` (8), `lifetime` (8), `embedded` (8), and `concurrency` (8) are populated; `codegen` has 4 guidelines; `simd` is not yet populated.

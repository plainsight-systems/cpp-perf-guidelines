...
- **Maturity:** early — `memory` (10), `copy-move` (8), `cache-layout` (8), and `lifetime` (8) are populated; the remaining four categories (`embedded`, `concurrency`, `codegen`, `simd`) are not yet populated.

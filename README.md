...
- **Maturity:** early — `memory` (10), `copy-move` (8), `cache-layout` (8), and `lifetime` (8) are populated; `embedded` has 4 guidelines; the remaining three categories (`concurrency`, `codegen`, `simd`) are not yet populated.
